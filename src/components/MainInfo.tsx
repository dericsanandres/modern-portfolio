  ...
  return (
    <div className='h-auto lg:h-[calc(100vh-180px)] flex flex-col lg:justify-between justify-normal lg:w-[550px] mr-auto w-full static lg:fixed'>
      <div className='space-y-3 mb-3 lg:mb-0'>
        <Link href='/'>
          <h1 className='md:text-5xl font-bold text-4xl inline-block'>{portfolioConfig.personal.name}</h1>
        </Link>
        <h2 className='text-xl md:text-2xl font-medium'>{portfolioConfig.personal.title}</h2>
